...
const (
	ConsumerService_ConsumeMessages_FullMethodName = "/consumer.ConsumerService/consumeMessages"
)
...
func (c *consumerServiceClient) ConsumeMessages(ctx context.Context, in *ConsumeRequest, opts ...grpc.CallOption) (*ConsumeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConsumeResponse)
	err := c.cc.Invoke(ctx, ConsumerService_ConsumeMessages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedConsumerServiceServer) ConsumeMessages(context.Context, *ConsumeRequest) (*ConsumeResponse, error) {
...
func _ConsumerService_ConsumeMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConsumeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConsumerServiceServer).ConsumeMessages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConsumerService_ConsumeMessages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsumerServiceServer).ConsumeMessages(ctx, req.(*ConsumeRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ConsumerService_ConsumeMessages_Handler,
		},
	},
